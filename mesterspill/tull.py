...
background = pygame.image.load("../../../Downloads/GameBackground.jpg")
...
def score_check():
    with open("../../../Downloads/high_score.txt", "r") as file:
        old_score = file.read()
        file.close()
    ...
    with open("../../../Downloads/high_score.txt", "w") as file:
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load("../../../Downloads/mesteren.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("../../../Downloads/lava.png")
        self.rect = self.image.get_rect()
...
class Coins(pygame.sprite.Sprite):
    def __init__(self):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.image.load("../../../Downloads/coin.png")
        self.rect = self.image.get_rect()
...
class Hitpoints(pygame.sprite.Sprite):
    def __init__(self, hits):
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.Surface((150-hits, 20))
        self.image.fill(red)
        self.rect = self.image.get_rect()
        self.rect.x = 10
        self.rect.y = 100
...
while game_loop:
    ...
    scoreboard()
    health_number_text(150-times_hit)

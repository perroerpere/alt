...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        if self.positions:
            last_pos_x, past_pos_y = self.positions[-1]
        ...
        if self.attached_to_wall:
            ...
            # Standard horisontal bevegelse
            if self.moving_right and self.rect.x >= last_pos_x:
                self.rect.x += self.speed
            if self.moving_left and self.rect.x <= last_pos_x:
                self.rect.x -= self.speed
...
level1 = (
    Ladder(color=red, width=500, height=50, x=700, y=700, move_range=(-500, 50), move_speed=1),
    #Ladder(color=maroon, width=50, height=900, x=100, y=200),
    Obstacle(color=blue, width=50, height=500, x=700, y=100),
    Ladder(color=red, width=10, height=500, x=690, y=100),
    #Ladder(color=cyan, width=100, height=500, x=1000, y=100),
    Ladder(color=lime, width=50, height=500, x=400, y=200),
    Obstacle(color=blue, width=500, height=50, x=800, y=600),
    #Ladder(color=navy, width=50, height=50, x=1300, y=10),
    #Ladder(color=fuchsia, width=250, height=50, x=1000, y=800, move_range=(-500, 50), move_speed=2),
)
level2 = (
    Ladder(color=blue, width=50, height=50, x=100, y=900),
    Ladder(color=blue, width=50, height=50, x=666, y=806),
    Ladder(color=blue, width=50, height=250, x=0, y=300),
    Ladder(color=blue, width=250, height=50, x=258, y=171),
    Ladder(color=blue, width=50, height=500, x=740, y=0),
    Ladder(color=blue, width=150, height=50, x=970, y=330),
    Ladder(color=blue, width=150, height=50, x=1200, y=180),
    Ladder(color=blue, width=125, height=50, x=300, y=900, move_range=(-100, 100), move_speed=1),
    Ladder(color=blue, width=125, height=50, x=300, y=600, move_range=(-100, 100), move_speed=1),
    Ladder(color=blue, width=125, height=50, x=840, y=575, move_range=(-100, 100), move_speed=1),

)
level3 = (
    Ladder(color=blue, width=50, height=350, x=100, y=100),
    Ladder(color=blue, width=50, height=350, x=100, y=650),
    Ladder(color=blue, width=50, height=350, x=400, y=100),
    Ladder(color=blue, width=50, height=350, x=400, y=650),
    Ladder(color=blue, width=50, height=350, x=700, y=100),
    Ladder(color=blue, width=50, height=350, x=700, y=650),
    Ladder(color=blue, width=50, height=350, x=1000, y=100),
    Ladder(color=blue, width=50, height=350, x=1000, y=650),
    Ladder(color=blue, width=50, height=350, x=1300, y=100),
    Ladder(color=blue, width=50, height=350, x=1300, y=650),
)
